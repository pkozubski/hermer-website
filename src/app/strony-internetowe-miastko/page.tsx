...
import { CheckCircle2, Search, Palette, Code2, Users, Layout, TrendingUp, Sparkles, FileText, Gift } from "lucide-react";
...
const miastkoFaq = [
  {
    id: 1,
    question: "Tworzenie stron www Miastko - czy warto zamówić projekt?",
    answer:
      "Masz wątpliwości czy posiadanie własnej strony jest opłacalne? Posiadanie witryny przyjaznej użytkownikom to znakomity sposób na to, by dowiedziało się o Twojej firmie wiele osób nie tylko z Miastka, ale i z najodleglejszych zakątków Polski. Efektywna i bezkonkurencyjna strona internetowa jest inwestycją, która zwróci się w krótkim czasie.",
  },
  {
    id: 2,
    question: "Pozycjonowanie stron internetowych Miastko",
    answer:
  ...
  {
    id: 3,
    question: "Jak długo trwa tworzenie stron www Miastko?",
    answer:
...
const klinikaNaNowoProject = {
  ...
  tags: ["UI/UX design", "Web Development", "Miastko"],
  image: klinikaNaNowoImg,
  link: "https://klinikananowo.pl/",
};

export default function MiastkoSeoPage() {
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-5xl space-y-24">
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                1. Zalety stron www Miastko
              </h2>
              <div className="h-1 w-24 bg-[#916AFF] mx-auto mb-8" />
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed mb-12">
                Najważniejsze jest aby szata graficzna strony był adekwatna do charakteru prowadzonej przez Ciebie działalności. Zapewniamy, że osiągniemy ten cel, ponieważ tworzenie stron Miastko odbywa się przy współpracy z Tobą i przy uwzględnieniu wszelkich Twoich sugestii.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                {[
                  "Atrakcyjność wizualna przyciągająca potencjalnych klientów.",
                  "Zwiększony ruch przekładający się na sprzedaż i zyski.",
                  "Łatwy w obsłudze panel do samodzielnego administrowania strony.",
                  "Bonus: darmowe utrzymanie domeny i hostingu przez rok.",
                  "Gwarancja satysfakcji – pracujemy do uzyskania oczekiwanego efektu."
                ].map((text, i) => (
                  <div key={i} className="flex items-start gap-4 p-6 rounded-2xl bg-neutral-800/40 border border-white/5">
                    <CheckCircle2 className="text-[#916AFF] mt-1 shrink-0" size={20} />
            ...
            <div className="p-12 rounded-[40px] bg-linear-to-br from-[#916AFF]/20 to-[#52D8EA]/20 border border-white/10 text-center relative overflow-hidden group">
              ...
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                2. Promocja pakietu VIP dla firm z Miastka
              </h2>
              <div className="h-1 w-24 bg-white/20 mx-auto mb-8" />
              <p className="text-neutral-200 text-xl leading-relaxed mb-10">
                By otrzymać rabat cenowy <strong>-31%</strong> zadzwoń pod numer tel. <strong>531 004 661</strong> lub napisz do nas na <strong>bok@e-hermer.pl</strong> informując nas, że jesteś z miasta Miastko, ponieważ w naszej ofercie na stronie www cena dla innych firm podana jest bez rabatu.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="tel:+48531004661" className="px-8 py-4 rounded-full bg-white text-black font-bold hover:bg-neutral-200 transition-colors">
                  Zadzwoń po rabat
                </a>
                <a href="mailto:bok@e-hermer.pl" className="px-8 py-4 rounded-full bg-white/10 border border-white/20 text-white font-bold hover:bg-white/20 transition-colors">
                  Napisz e-mail
                </a>
              </div>
            </div>
            ...
            <div className="p-12 rounded-[40px] bg-neutral-800/40 border border-white/5 text-center relative overflow-hidden group">
              <div className="absolute top-0 left-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                <FileText size={120} className="text-[#52D8EA]" />
              </div>
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                3. Zwiększenie zysków - Marketing
              </h2>
              <div className="h-1 w-24 bg-[#52D8EA] mx-auto mb-8" />
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed mb-10">
                Wraz ze stroną www otrzymasz od nas bezpłatnie raport – <strong>”Jak skutecznie wypromować moją stronę www”</strong>. Dzięki niemu będziesz miał wiedzę, jak poprowadzić kolejne działania marketingowe, czyli pozyskiwać kolejnych klientów. To dokładny i bardzo szczegółowy raport, którego koszt nominalny wynosi 300zł netto. <strong>Jako nasz nowy klient otrzymasz go BEZPŁATNIE</strong>.
              </p>
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-[#52D8EA]/10 border border-[#52D8EA]/20 text-[#52D8EA] font-bold">
                <Gift size={20} />
                Bonus o wartości 300zł
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 bg-neutral-900 border-t border-white/5 overflow-hidden">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-4xl md:text-6xl font-display font-medium tracking-tighter text-white mb-20">
              Działy wspierające tworzenie stron internetowych Miastko to:
            </h2>
