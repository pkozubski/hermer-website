...
const SEO_SLUG = "strony-internetowe-grudziadz";

const metadataFallback: Metadata = {
  title: "Strony internetowe Grudziądz - Strony www Grudziądz",
  description:
    "Strony internetowe Grudziądz to usługa stworzona specjalnie dla mieszkańców Grudziądza. Sprawdź naszą ofertę i Zadzwoń!",
  alternates: {
    canonical: "https://e-hermer.pl/strony-internetowe-grudziadz/",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Strony internetowe Grudziądz to usługa stworzona specjalnie dla mieszkańców Grudziądza. Sprawdź naszą ofertę i Zadzwoń!",
    url: "https://e-hermer.pl/strony-internetowe-grudziadz/",
    siteName: "Hermer",
    images: [
      {
        ...
        width: 1024,
        height: 980,
        alt: "strony internetowe grudziądz",
      },
    ],
  },
  twitter: {
...
export default function GrudziadzSeoLayout({
  children,
}: {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "WebPage",
                "@id": "https://e-hermer.pl/strony-internetowe-grudziadz/#webpage",
                url: "https://e-hermer.pl/strony-internetowe-grudziadz/",
                name: "Strony internetowe Grudziądz - Strony www Grudziądz",
                datePublished: "2024-08-30T06:29:51+00:00",
                dateModified: "2024-08-30T07:31:48+00:00",
              ...
              {
                "@type": "Article",
                headline: "Strony internetowe Grudziądz - Strony www Grudziądz",
                keywords: "strony internetowe grudziądz",
                datePublished: "2024-08-30T06:29:51+00:00",
                dateModified: "2024-08-30T07:31:48+00:00",
                ...
                description:
                  "Strony internetowe Grudziądz to usługa stworzona specjalnie dla mieszkańców Grudziądza. Sprawdź naszą ofertę i Zadzwoń!",
                name: "Strony internetowe Grudziądz - Strony www Grudziądz",
                "@id": "https://e-hermer.pl/strony-internetowe-grudziadz/#richSnippet",
                isPartOf: {
                  "@id": "https://e-hermer.pl/strony-internetowe-grudziadz/#webpage",
                },
                image: {
