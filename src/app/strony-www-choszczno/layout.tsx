...
const SEO_SLUG = "strony-www-choszczno";

const metadataFallback: Metadata = {
  title: "Strony www Choszczno - WWW Choszczno",
  description:
    "Strony www Choszczno to usługa stworzona specjalnie dla mieszkańców Choszczna. Sprawdź naszą ofertę i Zadzwoń!",
  alternates: {
    canonical: "https://e-hermer.pl/strony-www-choszczno/",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Strony www Choszczno to usługa stworzona specjalnie dla mieszkańców Choszczna. Sprawdź naszą ofertę i Zadzwoń!",
    url: "https://e-hermer.pl/strony-www-choszczno/",
    siteName: "Hermer",
    images: [
      {
...
export default function ChoszcznoSeoLayout({
  children,
}: {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "WebPage",
                "@id": "https://e-hermer.pl/strony-www-choszczno/#webpage",
                url: "https://e-hermer.pl/strony-www-choszczno/",
                name: "Strony www Choszczno - WWW Choszczno",
                datePublished: "2024-08-29T11:59:11+00:00",
                dateModified: "2024-08-30T06:48:57+00:00",
              ...
              {
                "@type": "Article",
                headline: "Strony www Choszczno - WWW Choszczno",
                keywords: "strony www choszczno",
                datePublished: "2024-08-29T11:59:11+00:00",
                dateModified: "2024-08-30T06:48:57+00:00",
                ...
                description:
                  "Strony www Choszczno to usługa stworzona specjalnie dla mieszkańców Choszczna. Sprawdź naszą ofertę i Zadzwoń!",
                name: "Strony www Choszczno - WWW Choszczno",
                "@id": "https://e-hermer.pl/strony-www-choszczno/#richSnippet",
                isPartOf: {
                  "@id": "https://e-hermer.pl/strony-www-choszczno/#webpage",
                },
                image: {
