...
import { CheckCircle2, Search, Palette, Code2, Users, Layout, TrendingUp, BarChart3 } from "lucide-react";
...
const gnieznoFaq = [
  {
    id: 1,
    question: "Tworzenie stron www Gniezno - czy warto zamówić projekt?",
    answer:
      "Masz wątpliwości czy posiadanie własnej strony jest opłacalne? Posiadanie witryny przyjaznej użytkownikom to znakomity sposób na to, by dowiedziało się o Twojej firmie wiele osób nie tylko z Gniezna, ale i z najodleglejszych zakątków Polski. Efektywna i bezkonkurencyjna strona internetowa jest inwestycją, która zwróci się w krótkim czasie.",
  },
  {
    id: 2,
    question: "Pozycjonowanie stron internetowych Gniezno",
    answer:
  ...
  {
    id: 3,
    question: "Jak długo trwa tworzenie stron www Gniezno?",
    answer:
...
const klinikaNaNowoProject = {
  ...
  tags: ["UI/UX design", "Web Development", "Gniezno"],
  image: klinikaNaNowoImg,
  link: "https://klinikananowo.pl/",
};

export default function GnieznoSeoPage() {
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-5xl space-y-24">
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                1. Lepsza widoczność w sieci
              </h2>
              <div className="h-1 w-24 bg-[#916AFF] mx-auto mb-8" />
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed">
                Dzięki umiejętnie zaprojektowanej stronie www zrobisz pozytywne wrażenie na swoich klientach. Zyskasz przewagę nad konkurencją, będziesz postrzegany jako profesjonalista przez osoby odwiedzające Twoją witrynę i zdobędziesz ich zaufanie. Działamy dla firm z Gniezna, które chcą dotrzeć z ofertą do klientów w swoim mieście, ale również osiągnąć zasięg ogólnopolski.
              </p>
            </div>
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                2. Większy ruch na stronie i nowi klienci
              </h2>
              <div className="h-1 w-24 bg-[#52D8EA] mx-auto mb-8" />
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed">
                Zachęcająca wizualnie strona, która jest jednocześnie funkcjonalna i posiada ważne dla klienta informacje, będzie realizować założone cele biznesowe. Chcesz zwiększyć ilość wejść na stronę, podnieść prestiż firmy, zachęcić ludzi do kontaktu oraz korzystania z oferty? Tworzenie stron internetowych Gniezno pomoże Ci osiągnąć znakomite wyniki w pełnym zakresie.
              </p>
            </div>

            {/* Section 3: Detailed Support */}
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
              ...
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed mb-12">
                Budujemy strony internetowe, opierając się na uzgodnionych wytycznych, przeprowadzonej analizie konkurencji oraz znajomości obowiązujących trendów i rozwiązań technicznych. Wymieniając się wiedzą i łącząc siły, przygotujemy witrynę dopracowaną pod kątem graficznym, technicznym oraz zoptymalizowaną pod działania marketingowe. W prace nad stroną zaangażowani będą:
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                {[
                  { title: "Menedżer projektów", desc: "koordynuje przepływ informacji oraz wszystkie działania związane z realizacją projektu" },
                  { title: "Graficy", desc: "zadbają o niepowtarzalny wygląd strony, spójny z tożsamością firmy" },
                  { title: "Programiści", desc: "po otrzymaniu projektu graficznego wykonają przejrzysty kod" },
                  { title: "Marketingowcy", desc: "zajmą się optymalizacją i promocją strony w internecie" },
                  { title: "Copywriter", desc: "napisze angażujące treści, które zachęcą klientów do działania" },
                  { title: "Specjalista UX", desc: "wykona schematyczny projekt ułatwiający pracę grafikom" }
                ].map((item, i) => (
        ...
        <section className="py-32 bg-neutral-900 border-t border-white/5 overflow-hidden">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-4xl md:text-6xl font-display font-medium tracking-tighter text-white mb-20">
              Działy wspierające tworzenie stron internetowych Gniezno to:
            </h2>
