...
import { CheckCircle2, Search, Palette, Code2, Users, Layout, TrendingUp, ShieldCheck, Zap } from "lucide-react";
...
const chojniceFaq = [
  {
    id: 1,
    question: "Dlaczego warto wybrać strony internetowe Chojnice?",
    answer:
      "Projektowanie stron internetowych Chojnice jest ofertą, dzięki której będziesz mógł pokazać klientom z Chojnic i nie tylko, że stawiasz na wysoką jakość, czym zdobędziesz ich zaufanie. Dopracowana witryna przyczyni się to do wzrostu sprzedaży Twoich produktów bądź usług, co w konsekwencji doprowadzi do podniesienia dochodów. Zarabiając na nowej stronie internetowej, zyskujesz możliwość rozwoju swojego przedsiębiorstwa.",
  },
  {
    id: 2,
    question: "Pozycjonowanie stron internetowych Chojnice",
    answer:
  ...
  {
    id: 3,
    question: "Jak długo trwa tworzenie stron www Chojnice?",
    answer:
...
const klinikaNaNowoProject = {
  ...
  tags: ["UI/UX design", "Web Development", "Chojnice"],
  image: klinikaNaNowoImg,
  link: "https://klinikananowo.pl/",
};

export default function ChojniceSeoPage() {
        ...
        <section className="py-24 container mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-6">
              Decydując się na stronę internetową Chojnice:
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-neutral-800/50 border border-white/5 text-center">
              ...
              <p className="text-neutral-400 text-sm">
                Szata graficzna strony będzie ciekawsza niż u konkurencji.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-neutral-800/50 border border-white/5 text-center">
              ...
              <h3 className="text-xl font-bold mb-4 font-display">
                Zyskasz zainteresowanie
              </h3>
              <p className="text-neutral-400 text-sm">
                Klienci chętnie pozostaną na Twojej stronie.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-neutral-800/50 border border-white/5 text-center">
              ...
              <p className="text-neutral-400 text-sm">
                Zbudujemy stronę www i zajmiemy się jej promocją.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-8 max-w-5xl space-y-24">
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                1. Wyróżnisz się spośród konkurencji
              </h2>
              <div className="h-1 w-24 bg-[#916AFF] mx-auto mb-8" />
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed">
                Tworzenie stron internetowych najlepiej powierzyć specjalistom, którzy wiedzą, jak powinna wyglądać unikatowa witryna. Dzięki przeprowadzeniu dokładnej analizy konkurencji stworzymy projekt, który wyróżni Twoją firmę spośród innych stron. Profesjonalna strona pozytywnie wpłynie na wizerunek firmy, podnosząc jej prestiż, a także pomoże zdobyć zaufanie wśród klientów. Zadbamy o to, by strona wizualnie była interesująca dla odwiedzających oraz działała niezawodnie. Pamiętaj, że użyteczne strony internetowe zdobywają więcej klientów, podnosząc zyski firmy.
              </p>
            </div>
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                2. Zyskasz zainteresowanie ze strony klientów
              </h2>
              <div className="h-1 w-24 bg-[#52D8EA] mx-auto mb-8" />
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed">
                Projektowanie stron Chojnice to oferta specjalna skierowana do firm, które chcą się rozwijać i pozyskiwać klientów na rynku lokalnym oraz rozszerzyć sprzedaż o zasięg ogólnopolski. Jeżeli zamierzasz prześcignąć konkurencję, potrzebujesz nowoczesnej strony internetowej, która wzbudzi zainteresowanie użytkowników internetu. Odpowiednie zaprezentowanie oferty, przejrzystość i możliwość wygodnego korzystania ze strony, która szybko się ładuje to atuty strony należącej do małej bądź dużej firmy.
              </p>
            </div>
            ...
            <div className="text-center">
              <h2 className="text-3xl md:text-5xl font-display font-medium tracking-tighter mb-8">
                3. Otrzymasz fachową pomoc
              </h2>
              <div className="h-1 w-24 bg-[#916AFF] mx-auto mb-8" />
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed mb-12">
                Z pomocą zespołu, do którego należą osoby specjalizujące się w wielu dziedzinach, zyskasz stronę internetową przynoszącą Ci wymierne zyski. Tworzenie stron Chojnice obejmuje wsparcie specjalistów, którzy będą czuwać nad sprawnym przebiegiem prac:
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                {[
                  { title: "Menedżer projektów", desc: "koordynacja tworzenia strony" },
                  { title: "Graficy & Programiści", desc: "projekt graficzny oraz kodowanie strony" },
                  { title: "Marketing & Copywriting", desc: "poprawa widoczności strony w internecie i SEO" },
                  { title: "Analityk UX", desc: "dobór elementów strony dla maksymalnej użyteczności" }
                ].map((item, i) => (
        ...
        <section className="py-32 bg-neutral-900 border-t border-white/5 overflow-hidden">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-4xl md:text-6xl font-display font-medium tracking-tighter text-white mb-20">
              Działy wspierające tworzenie stron internetowych Chojnice to:
            </h2>
