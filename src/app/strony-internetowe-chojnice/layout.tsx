...
const SEO_SLUG = "strony-internetowe-chojnice";

const metadataFallback: Metadata = {
  title: "Strony internetowe Chojnice - Strony WWW Chojnice",
  description:
    "Strony internetowe Chojnice to oferta stworzą z myślą o mieszkańcach Chojnic. Sprawdź naszą ofertę i Zadzwoń!",
  alternates: {
    canonical: "https://e-hermer.pl/strony-internetowe-chojnice/",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      "Strony internetowe Chojnice to oferta stworzą z myślą o mieszkańcach Chojnic. Sprawdź naszą ofertę i Zadzwoń!",
    url: "https://e-hermer.pl/strony-internetowe-chojnice/",
    siteName: "Hermer",
    images: [
      {
        ...
        width: 1024,
        height: 980,
        alt: "strony internetowe chojnice",
      },
    ],
  },
  twitter: {
...
export default function ChojniceSeoLayout({
  children,
}: {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "WebPage",
                "@id": "https://e-hermer.pl/strony-internetowe-chojnice/#webpage",
                url: "https://e-hermer.pl/strony-internetowe-chojnice/",
                name: "Strony internetowe Chojnice - Strony WWW Chojnice",
                datePublished: "2024-08-30T05:51:18+00:00",
                dateModified: "2024-08-30T06:53:57+00:00",
              ...
              {
                "@type": "Article",
                headline: "Strony internetowe Chojnice - Strony WWW Chojnice",
                keywords: "strony internetowe chojnice",
                datePublished: "2024-08-30T05:51:18+00:00",
                dateModified: "2024-08-30T06:53:57+00:00",
                ...
                description:
                  "Strony internetowe Chojnice to oferta stworzą z myślą o mieszkańcach Chojnic. Sprawdź naszą ofertę i Zadzwoń!",
                name: "Strony internetowe Chojnice - Strony WWW Chojnice",
                "@id": "https://e-hermer.pl/strony-internetowe-chojnice/#richSnippet",
                isPartOf: {
                  "@id": "https://e-hermer.pl/strony-internetowe-chojnice/#webpage",
                },
                image: {
