...
const zielonaGoraFaq = [
  ...
  {
    id: 3,
    question: "Jak długo trwa tworzenie stron www Zielona Góra?",
    answer:
...
const klinikaNaNowoProject = {
  ...
  tags: ["UI/UX design", "Web Development", "Zielona Góra"],
  image: klinikaNaNowoImg,
  link: "https://klinikananowo.pl/",
};

export default function ZielonaGoraSeoPage() {
        ...
        <section className="py-24 bg-neutral-800/20 border-y border-white/5">
          <div className="container mx-auto px-4 md:px-8 max-w-5xl space-y-24">
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed">
                Uzyskujemy znakomite efekty sprzedażowe, dzięki temu, że strony www tworzymy wykorzystując sprawdzony sposób. Takie same rezultaty osiągniemy przygotowując strony internetowe Zielona Góra. Przeprowadzone liczne analizy potwierdzają fakt, że znacznie więcej osób pozostaje na naszych stronach internetowych, niż na przeciętnych stronach konkurencyjnych.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-300 text-lg md:text-xl leading-relaxed mb-12">
                Strony internetowe dedykowane dla Zielonej Góry realizują wszystkie założone cele przypisane dla tego miasta, jak i dla całej Polski. Dba o to nasz cały sztab specjalistów, który zawsze jest do Twojej dyspozycji.
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                {[
                  { title: "Menedżer projektów (Kamila)", desc: "Centrum dowodzenia dbające o terminowość, przepływ informacji i zgodność z ustaleniami." },
                  { title: "Copywriter (Kasia)", desc: "Zadba o lekkie, profesjonalne treści zachęcające do zakupu i budujące zaufanie." },
                  { title: "Graficy (Katarzyna, Adam)", desc: "Zadbają o unikalny wygląd strony, który wyróżni Cię na tle konkurencji." },
                  { title: "Programiści (Dawid, Bartek, ...)", desc: "Perfekcyjny kod to bezawaryjność i fundament pod skuteczne pozycjonowanie." },
                  { title: "Marketingowcy (Łukasz, Darek)", desc: "Analiza rynku i przygotowanie planu pozyskiwania nowych klientów." },
                  { title: "Analityk UX (Jacek)", desc: "Precyzyjne rozrysowanie każdego modułu dla maksymalnej konwersji." }
                ].map((item, i) => (
        ...
        <section className="py-32 bg-neutral-900 border-t border-white/5 overflow-hidden">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-4xl md:text-6xl font-display font-medium tracking-tighter text-white mb-20">
              Działy wspierające tworzenie stron internetowych Zielona Góra to:
            </h2>
