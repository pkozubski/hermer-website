...
import { AnimatedPath } from "../ui/AnimatedPath";
...
export const Contact: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <AnimatedPath
        d="M944.085 74.2329C848.351 28.0949 679.635 -18.8107 578.449 50.4578C538.179 78.0253 508.605 123.993 498.585 195.733C454.585 510.733 824.584 414.733 714.084 195.733C681.961 132.069 633.105 83.32 578.449 50.4578C445.093 -29.723 277.206 -15.3299 233.584 107.733C172.084 281.233 198.94 569.011 81.584 533.733C0.0839844 509.233 64.584 655.733 0.0839844 666.733"
        viewBox="0 -30 945 697"
        baseColor="#52D8EA"
        triggerStart="top 60%"
        parallaxY={120}
      />
          ...
          <div className="w-full lg:w-5/12 pt-4">
            ...
            <div className="space-y-12">
              {[
                {
                  label: "Email",
                  value: "bok@e-hermer.pl",
                  href: "mailto:bok@e-hermer.pl",
                },
                {
                  label: "Telefon",
                  value: "+48 666 829 895",
                  href: "tel:+48666829895",
                },
                {
                  label: "Biuro",
                  value: "ul. Bydgoska 50, Wałcz",
                  href: "#",
                },
              ].map((item, i) => (
                <div
