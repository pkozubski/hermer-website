    ...
    >
      ...
      {!isSafari && (
        <AnimatedPath
          ...
          containerClassName="absolute inset-0 w-full h-full pointer-events-none z-0 overflow-hidden"
          svgClassName="absolute w-[108%] h-full"
          scrollTriggerElement={containerRef}
          triggerStart="top bottom"
          triggerEnd="bottom top"
          drawStartRatio={0.30}
          drawDurationRatio={0.35}
          fadeProgressRatio={0}
          parallaxY={120}
        />
      )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6 auto-rows-[minmax(180px,auto)] mx-auto">
          ...
          <div className="md:col-span-6 lg:col-span-4 relative z-0 group/image-card min-h-[400px] w-full h-full rounded-[32px] border border-white/5 bg-[#232323] text-white font-sans overflow-hidden shadow-2xl transition-[border-color] duration-500 hover:border-white/10 group">
            ...
            <div className="absolute bottom-0 right-[-32px] w-[300px] h-[126%] z-10 pointer-events-none hidden md:block">
              <img
                src="/images/img-onas-jacek.webp"
                alt="Jacek"
          ...
          >
            ...
            <div className="relative p-8 flex flex-col h-full justify-between z-10">
              ...
              {/* Typography */}
              <div className="mt-8">
                <h4 className="text-3xl font-normal text-white mb-3 flex items-center gap-2 group-hover/team:text-[#916AFF] transition-colors duration-300">
                  Wsparcie ekspertów
                </h4>
                <p className="text-neutral-400 text-sm font-normal leading-relaxed">
