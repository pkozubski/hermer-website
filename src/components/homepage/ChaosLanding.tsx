  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute left-1/2 -translate-x-1/2 top-[17%] origin-bottom md:origin-right md:left-auto md:translate-x-0 md:bottom-auto md:right-[15%] md:top-1/2 md:-translate-y-1/2 w-[300px] md:w-[375px] h-[650px] md:h-[812px] opacity-0 pointer-events-none z-0 scale-[0.6] md:scale-[0.45]"
      >
      ...
      <div className="absolute left-1/2 -translate-x-1/2 top-[17%] origin-bottom md:origin-right md:left-auto md:translate-x-0 md:bottom-auto md:right-[15%] md:top-1/2 md:-translate-y-1/2 w-[300px] md:w-[375px] h-[650px] md:h-[812px] z-10 pointer-events-none scale-[0.6] md:scale-[0.45]">
