...
const ContractVisualInner: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[160px] sm:h-[180px] md:h-[200px] flex items-end justify-start mt-4">
      ...
      <div
        className="relative z-10 w-[88%] h-full rounded-2xl bg-[#262626] border-[5px] border-white/5 p-5 sm:p-6 flex flex-col justify-between overflow-hidden shadow-[0px_0px_48px_10px_rgba(0,0,0,0.2),0px_4px_16px_8px_rgba(0,0,0,0.1)] rotate-[-3deg] group-hover/shield:rotate-0 group-hover/shield:scale-[1.03] transition-transform duration-300"
      >
        {/* Fake document lines */}
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="relative w-12 h-12 sm:w-14 sm:h-14 shrink-0">
            <div className="absolute inset-0 rounded-full border-2 border-dashed border-[#9b87f5]/40 animate-[spin_30s_linear_infinite]" />
  ...
  return (
    ...
    >
      ...
      <div className="relative p-8 flex flex-col h-full z-10">
        {/* Typography */}
        <div>
          <h4 className="text-3xl font-normal text-white mb-3 flex items-center gap-2 group-hover/shield:text-[#916AFF] transition-colors duration-300">
