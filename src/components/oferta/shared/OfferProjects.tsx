...
import { ProjectCardScrollShaderOverlay } from "../../homepage/ProjectCardScrollShader";
...
export const OfferProjects: React.FC<OfferProjectsProps> = ({ category }) => {
  ...
  return (
    <section id="realizacje" className="py-24 bg-transparent border-t border-white/5">
