...
export const PricingSection: React.FC = () => {
    return (
        <section id="pricing" className="py-24 bg-white relative">
            {/* Decoration */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-slate-50 rounded-full blur-3xl -z-10"></div>
            ...
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    {/* START */}
                    <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-lg shadow-slate-200/50 hover:-translate-y-1 transition-transform duration-300">
                        <div className="mb-8">
                        ...
                        <div className="mb-8 flex items-baseline gap-1">
                            ...
                            <span className="text-xs text-slate-400 ml-2">netto</span>
                        </div>
                        ...
                        <Link
                            href="#contact"
                            className="block w-full py-4 rounded-xl border border-slate-200 text-center font-semibold text-slate-900 hover:border-[#916AFF] hover:text-[#916AFF] transition-all"
                        >
                            Wybieram Start
                        </Link>
                    </div>
                    ...
                    {/* BUSINESS (Featured) */}
                    <div className="bg-neutral-900 p-8 lg:p-10 rounded-3xl border border-neutral-800 shadow-2xl relative scale-105 z-10 text-white">
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-lg shadow-slate-200/50 hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <div className="mb-8 flex items-baseline gap-1">
                            ...
                            <span className="text-slate-500 font-medium">indywidualna</span>
                        </div>
                        <ul className="space-y-4 mb-8">
                            <li className="flex items-center gap-3 text-sm text-slate-600">
                                <CheckCircle2 className="text-[#916AFF] w-5 h-5" />
