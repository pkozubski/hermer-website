                ...
                <div className="space-y-8">
                  <div className="flex items-center justify-between border-b border-white/10 pb-8">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <h3 className="text-white text-2xl font-display font-medium tracking-tight">
                          Twój Sklep
                        </h3>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="bg-white/5 p-6 rounded-xl border border-white/5">
                      <p className="text-neutral-400 text-xs mb-3 uppercase tracking-widest font-medium">
                        Sprzedaż dzisiaj
                      </p>
                      <p className="text-white text-3xl lg:text-4xl font-display font-semibold tracking-tight">
                        2 450 PLN
                      </p>
                    </div>
                    <div className="bg-white/5 p-6 rounded-xl border border-white/5">
                  ...
                  <div className="w-full h-40 bg-white/5 rounded-xl border border-white/5 flex items-end justify-between px-3 pb-3 gap-3">
                    {[40, 65, 45, 80, 55, 90, 70].map((h, i) => (
                      <div
                        key={i}
                        className="w-full bg-[#916AFF]/50 rounded-md hover:bg-[#916AFF] transition-colors duration-300 relative group/bar"
                        style={{ height: `${h}%` }}
                      >
