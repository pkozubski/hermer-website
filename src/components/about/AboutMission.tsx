        ...
        <div className="flex flex-col items-start gap-24">
          <div className="w-full max-w-5xl">
            <SplitRevealTitle
              line1="Nasza"
              line2="Misja"
              className="text-6xl md:text-8xl font-display font-medium tracking-tighter text-slate-900"
            />
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 w-full">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:col-span-7 bg-[#FAFAFA] rounded-[3rem] p-10 md:p-16 relative overflow-hidden group hover:shadow-2xl hover:shadow-slate-200 transition-all duration-500 border border-slate-100"
            >
              {/* Decorative Circle */}
              ...
              <div className="relative z-10">
                <p className="text-3xl md:text-5xl font-light text-slate-900 leading-[1.15]">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center gap-12 pl-4">
              <div className="group cursor-default">
                <div className="flex items-center gap-4 text-[#916AFF] font-bold uppercase tracking-widest text-xs mb-4 group-hover:translate-x-2 transition-transform duration-300">
                  <div className="w-10 h-10 rounded-full bg-[#f4f1ff] flex items-center justify-center">
                    <CheckCircle2 size={18} />
                  </div>
                  Wiedza to priorytet
                </div>
                <p className="text-slate-600 leading-relaxed text-xl font-light border-l-2 border-slate-100 pl-6 group-hover:border-[#916AFF] transition-colors duration-300">
              ...
              <div className="group cursor-default">
                ...
                <p className="text-slate-600 leading-relaxed text-xl font-light border-l-2 border-slate-100 pl-6 group-hover:border-sky-500 transition-colors duration-300">
