      ...
      <div key={phase} ref={phaseRef} className="h-full">
        ...
        {phase === 2 && (
          <div className="flex h-full flex-col items-center justify-center px-3 text-center">
            ...
            <p className="mb-2 text-[14px] font-medium text-white/90">
              Twoja strona jest
            </p>
            <p className="mb-4 text-[18px] font-semibold text-[#916aff]">
              w budowie
            </p>
        ...
        {phase === 3 && (
          <div className="relative flex h-full flex-col items-center justify-center px-4 text-center">
            ...
            <p className="mb-1 text-[12px] text-white/80">
              Wystarczy jeden krok
            </p>
            <p className="mb-5 text-[15px] font-medium text-white/90">
...
export function CTASection({
  titleLine1 = "Gotowy na",
  titleLine2 = "zmianę?",
  subtitleLines = DEFAULT_SUBTITLE_LINES,
}: CTASectionProps) {
  return (
    <section
        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-8">
          <div className="flex flex-1 flex-col items-center text-center lg:items-start lg:text-left">
            <SplitRevealTitle
              line1={titleLine1}
              line2={titleLine2}
              className="text-5xl tracking-tighter text-white md:text-8xl"
            />
