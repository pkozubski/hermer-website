        ...
        <div className="flex-1 overflow-hidden space-y-3 p-3">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <div className="h-2 w-20 bg-neutral-800 rounded-sm"></div>
              <div className="ml-auto text-[8px] text-[#916AFF] font-medium">
                Teraz
              </div>
            </div>
            {/* Content */}
            <div className="w-full h-24 bg-neutral-800 rounded-lg flex items-center justify-center relative group cursor-default overflow-hidden">
              <div className="absolute inset-0 bg-[#916AFF]/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <Heart
                size={28}
                className="text-neutral-700 fill-[#916AFF] opacity-0 group-hover:scale-110 group-hover:opacity-100 transition-all duration-300 drop-shadow-[0_4px_6px_rgba(145,106,255,0.4)]"
              />
            </div>
            {/* Actions */}
            <div className="flex gap-3 text-neutral-600">
              ...
              <Share2
                size={14}
                className="hover:text-neutral-400 transition-colors cursor-pointer ml-auto"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 opacity-40 grayscale">
            ...
            {/* Content */}
            <div className="w-full h-16 bg-neutral-800 rounded-lg"></div>
          </div>
        </div>
      </div>
    </CardFrame>
