  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        {/* Chart Visualization */}
        <div className="absolute bottom-4 left-0 right-0 mx-auto w-[85%] @lg:w-auto @lg:inset-auto @lg:-bottom-12 @lg:-left-[100px] @lg:right-[40%] @lg:top-[20%] z-10 flex flex-col justify-end @lg:block pointer-events-none">
          {/* Header Label */}
      ...
      <div className="absolute right-0 top-0 bottom-0 w-full @lg:w-full @lg:max-w-[500px] p-8 @lg:p-12 flex flex-col justify-start items-end z-20 pointer-events-none">
        <div className="pointer-events-auto">
          <div className="relative z-10 text-right">
            <div className="pb-6 mb-6">
              <h3 className="text-3xl @lg:text-5xl font-bold tracking-tight text-white mb-2">
                Marketing internetowy
              </h3>
            </div>

            <div>
              <p className="text-neutral-400 text-sm @lg:text-base font-medium leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity duration-500 max-w-lg ml-auto">
